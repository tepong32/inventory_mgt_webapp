"""
Django settings for inv_mgt_webapp project.
...
SECRET_KEY = 'sa^rl(iy6oc@-9i6_r_2p8%5n@#s8*)lzdz)k_c(p+#%4#&u9e'
...
ROOT_URLCONF = 'inv_mgt_webapp.urls'
...
WSGI_APPLICATION = 'inv_mgt_webapp.wsgi.application'
